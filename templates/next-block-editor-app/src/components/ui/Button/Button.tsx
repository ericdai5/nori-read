    ...
    const buttonClassName = cn(
      ...
      variant === 'ghost' &&
        cn(
          ...
          !disabled &&
            !active &&
            'hover:bg-black/5 hover:text-neutral-600 active:bg-black/10 active:text-neutral-700 dark:hover:bg-white/10 dark:hover:text-neutral-300 dark:active:text-neutral-200',
          active && cn('bg-black/10 text-neutral-700 dark:bg-white/20 dark:text-neutral-200', activeClassname)
        ),
